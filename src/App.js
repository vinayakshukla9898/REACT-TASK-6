      ...
      <div className="main-content">
        {selectedSection === "Home" && (
          <div className="content-section">
            ...
            <p>
              I'm VINAYAK SHUKLA, a web developer who's dedicated to crafting
...
monitor and assess the health and performance of electric vehicle (EV) motors in real-time.
            ...
            <div className="content-section">
              <h2>About Me</h2>
              <p>
                Hi, I'm VINAYAK SHUKLA, a web developer with expertise in HTML and
            ...
            <div className="content-section">
              ...
              <div className="content-section">
                <h2>Contact Me</h2>
                <p>Name: VINAYAK SHUKLA</p>
                <p>Mobile: 8306077257</p>
                <p>Email: vinayak2shukla@gmail.com</p>
                <p>
                  Linkedin:{" "}
                  <a href="https://www.linkedin.com/in/vinayak-shukla-26b567226">
                    {" "}
                    Vinayak Shukla{" "}
                  </a>
                </p>
      ...
      {selectedSection === "About" && (
        <div className="content-section">
          <h2>About Me</h2>
          <p>
            Hi, I'm VINAYAK SHUKLA,  a web developer with expertise in HTML and CSS.
